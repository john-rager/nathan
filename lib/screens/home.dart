...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    appState.instances.addListener(() {
      if (appState.selectedIndex.value == null &&
          appState.instances.value.isNotEmpty) appState.selectedIndex.value = 0;
      setState(() {});
    });
    _refreshWorkflows();
  }
  ...
  void _selectWorkflow(Workflow w) {
    ...
    Navigator.of(context).push(MaterialPageRoute(
        builder: (_) => WorkflowDetailScreen(
            workflow: w, instanceUrl: inst.url, apiKey: inst.apiKey)));
  }
  ...
  Widget _workflowCard(Workflow w) {
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Text('Updated ${_fmtRelativeDate(w.updatedAt)}',
            ...
            child: CustomScrollView(slivers: [
              ...
              SliverList(
                  delegate: SliverChildBuilderDelegate(
                      (ctx, i) => _workflowCard(workflows[i]),
